...
const EUnrealEngineObjectUE4Version = {
...
const EUnrealEngineObjectUE5Version = {
...
class ReaderUasset {
    ...
    addHexView(key, type, value, startPosition, stopPosition) { /* eslint-disable-line max-params */
